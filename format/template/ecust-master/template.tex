...
\setCJKmainfont[Path=./SimSun/, Extension=.TTC, AutoFakeBold=true]{SIMSUN} % 设置宋体伪粗体
\setCJKfamilyfont{zhsong}[Path=./SimSun/, Extension=.TTC, AutoFakeBold=true]{SIMSUN}
\setCJKfamilyfont{zhhei}[Path=./SimHei/, Extension=.TTF, AutoFakeBold=true]{SIMHEI}
\renewcommand{\songti}{\CJKfamily{zhsong}}
\renewcommand{\heiti}{\CJKfamily{zhhei}}
\let\kaishu\relax
\newCJKfontfamily\kaishu[Path=./KaiTi/, Extension=.TTF, AutoFakeBold=true]{SIMKAI} % 设置楷体伪粗体
...
\subsection{研究背景及意义}
\zihao{-4}
由于绪论\cite{示例期刊论文}绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论\cite{示例书籍}绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论。

\subsection{国内外研究现状}
本课题涉及绪论绪论绪论\cite{示例学位论文}绪论绪论绪论绪论绪论绪论绪论绪论绪论\cite{示例会议论文}绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论。

\subsubsection{相关研究}
绪论绪论绪论绪论绪论绪论绪论绪论\cite{示例期刊论文}绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论\cite{示例在线资源}绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论绪论。

\newpage
\section{理论基础}
理论基础理论基础理论基础理论基础理论基础理\cite{示例在线资源}论基础理论基础理论基础理论基础理论基础理论基础理论基础理论基础理论基础理论基础理论基础理论基础理论基础理论基础。

\subsection{方法}
方法方法方法方法方法方法方法方法方法方法方法方法方法\cite{示例会议论文}方法方法方法方法方法方法\cite{示例期刊论文,示例书籍}方法方法方法。

如图\ref{f1}所示。
\begin{figure}[!h]
	\centering
	\includegraphics[width=0.6\textwidth]{chudaixiake.png}
	\bicaption{图像示例}{Image example}
	\label{f1}
\end{figure}
...
\begin{figure}[!h]
	\centering
	\subfloat[baseline\label{f2:a}]{\includegraphics[width=0.45\textwidth]{chudaixiake.jpg}}\\
	\subfloat[ours]{\includegraphics[width=0.45\textwidth]{chudaixiake.jpg}}\\
